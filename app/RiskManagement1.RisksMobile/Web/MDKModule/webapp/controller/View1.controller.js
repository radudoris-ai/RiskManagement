sap.ui.define([
	...
	return Controller.extend("RiskManagement1.RisksMobile.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("RiskManagement1/RisksMobile/mdkindex.html?" + queryString);
